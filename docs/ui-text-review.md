...
- 사용: `apps/web/src/pages/AccountPage.tsx:335`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:343`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:356`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:362`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:369`, `apps/web/src/pages/AccountPage.tsx:543`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:530`
- 수정안:
...
- 현재: Tango는 계정 이용 시 이메일, 선택적으로 해시 처리된 비밀번호, Google 계정 식별자, 닉네임, 아바타, 레이팅, 전적, 출석 기록, 컬러 칩 잔액과 원장, 보유·장착 스킨, 파편·상자 결과와 쿠폰 수령 기록을 처리합니다. 서비스 운영과 반복 보상 방지를 위해 서명된 익명 게스트 식별자, 접속 경로, 브라우저 정보를 처리할 수 있습니다.
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:194`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:548`, `apps/web/src/pages/PrivacyPage.tsx:17`
- 수정안:
...
- 사용: `apps/web/src/components/AppSidebar.tsx:41`, `apps/web/src/pages/LobbyPage.tsx:137`, `apps/web/src/pages/PatchNotesPage.tsx:21`
- 수정안:
...
- 사용: `apps/web/src/components/AppSidebar.tsx:30`, `apps/web/src/components/AppSidebar.tsx:45`, `apps/web/src/pages/GamePage.tsx:341`, `apps/web/src/pages/OnlineRoomPage.tsx:817`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:60`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:69`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:70`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:88`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:89`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:108`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:109`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:134`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:147`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:166`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:175`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:116`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:117`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:136`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:196`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:197`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:185`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:174`, `apps/web/src/pages/OnlineRoomPage.tsx:875`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:174`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:206`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyQuestGrid.tsx:64`, `apps/web/src/pages/LobbyPage.tsx:210`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:214`
- 수정안:
...
- 사용: `apps/web/src/pages/MatchmakingPage.tsx:161`, `apps/web/src/pages/OnlineRoomPage.tsx:756`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:316`, `apps/web/src/pages/AccountPage.tsx:345`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:658`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:663`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:320`, `apps/web/src/pages/OnlineRoomPage.tsx:673`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:735`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:741`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:745`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:762`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:763`, `apps/web/src/pages/OnlineRoomPage.tsx:908`, `apps/web/src/pages/SpectatePage.tsx:82`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:766`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:322`, `apps/web/src/pages/OnlineRoomPage.tsx:788`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:320`, `apps/web/src/pages/OnlineRoomPage.tsx:786`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:333`, `apps/web/src/pages/OnlineRoomPage.tsx:808`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:340`, `apps/web/src/pages/OnlineRoomPage.tsx:816`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:815`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:400`, `apps/web/src/pages/OnlineRoomPage.tsx:878`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:946`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:300`, `apps/web/src/pages/AccountPage.tsx:333`, `apps/web/src/pages/LobbyPage.tsx:200`, `apps/web/src/pages/StorePage.tsx:159`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:301`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:305`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:309`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:333`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:550`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:365`, `apps/web/src/pages/AccountPage.tsx:539`, `apps/web/src/pages/AccountPage.tsx:566`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:426`, `apps/web/src/pages/AccountPage.tsx:579`, `apps/web/src/pages/StorePage.tsx:395`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:549`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:383`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:385`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:392`, `apps/web/src/pages/AccountPage.tsx:440`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:393`, `apps/web/src/pages/AccountPage.tsx:441`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:395`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:396`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:419`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:463`
- 수정안:
...
- 사용: `apps/web/src/pages/ReplayPage.tsx:193`
- 수정안:
...
- 사용: `apps/web/src/pages/ReplayPage.tsx:224`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:62`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:159`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:653`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:757`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:789`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:856`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:380`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:325`
- 수정안:
...
- 사용: `apps/web/src/components/GameBoard.tsx:96`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:396`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:410`, `apps/web/src/pages/OnlineRoomPage.tsx:888`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:411`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:140`, `apps/web/src/pages/GamePage.tsx:413`, `apps/web/src/pages/OnlineRoomPage.tsx:891`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:417`, `apps/web/src/pages/OnlineRoomPage.tsx:892`
- 수정안:
...
- 사용: `apps/web/src/components/ColorPicker.tsx:20`
- 수정안:
...
- 사용: `apps/web/src/components/GameBoard.tsx:79`
- 수정안:
...
- 사용: `apps/web/src/components/GameBoard.tsx:94`
- 수정안:
...
- 사용: `apps/web/src/components/GameBoard.tsx:95`
- 수정안:
...
- 사용: `apps/web/src/components/ResultPanel.tsx:68`
- 수정안:
...
- 사용: `apps/web/src/components/ResultPanel.tsx:69`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:940`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:934`
- 수정안:
...
- 사용: `apps/web/src/components/TutorialPanel.tsx:292`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:135`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:148`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:167`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:122`, `apps/web/src/pages/AccountPage.tsx:395`, `apps/web/src/pages/AccountPage.tsx:396`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:446`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:626`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:634`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:889`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:579`, `apps/web/src/pages/OnlineRoomPage.tsx:595`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:579`, `apps/web/src/pages/OnlineRoomPage.tsx:595`, `apps/web/src/pages/SpectatePage.tsx:53`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:580`, `apps/web/src/pages/OnlineRoomPage.tsx:596`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:580`, `apps/web/src/pages/OnlineRoomPage.tsx:596`, `apps/web/src/pages/SpectatePage.tsx:53`
- 수정안:
...
- 사용: `apps/web/src/pages/ReplayPage.tsx:232`, `apps/web/src/pages/SpectatePage.tsx:105`
- 수정안:
...
- 사용: `apps/web/src/pages/ReplayPage.tsx:202`
- 수정안:
...
- 사용: `apps/web/src/pages/ReplayPage.tsx:209`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:843`
- 수정안:
...
- 사용: `apps/web/src/pages/GamePage.tsx:367`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:142`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:152`, `apps/web/src/pages/LobbyPage.tsx:153`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:165`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:166`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:129`, `apps/web/src/pages/LobbyPage.tsx:133`, `apps/web/src/pages/LobbyPage.tsx:180`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:204`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:189`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:200`
- 수정안:
...
- 사용: `apps/web/src/components/SettingsPanel.tsx:190`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:912`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:918`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:919`
- 수정안:
...
- 사용: `apps/web/src/components/PatchNotesPanel.tsx:211`
- 수정안:
...
- 사용: `apps/web/src/components/CosmeticOutcomeModal.tsx:52`, `apps/web/src/components/EconomyAccountPanel.tsx:413`, `apps/web/src/components/PatchNotesPanel.tsx:230`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:256`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:394`, `apps/web/src/pages/AccountPage.tsx:442`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:439`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:394`, `apps/web/src/pages/StorePage.tsx:141`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:139`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:147`, `apps/web/src/pages/StorePage.tsx:147`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:157`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:158`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:191`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:123`, `apps/web/src/pages/StorePage.tsx:286`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:124`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:80`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:396`, `apps/web/src/pages/StorePage.tsx:301`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:302`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:312`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:315`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:398`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:354`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:355`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:361`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:366`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:311`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:333`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:334`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:335`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:340`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:121`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:124`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:126`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:148`
- 수정안:
...
- 사용: `apps/web/src/components/AttendanceCheckInModal.tsx:145`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:276`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:290`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:232`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:253`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:689`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:691`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:707`
- 수정안:
...
- 사용: `apps/web/src/components/ResultPanel.tsx:74`, `apps/web/src/pages/OnlineRoomPage.tsx:717`
- 수정안:
...
- 사용: `apps/web/src/pages/OnlineRoomPage.tsx:723`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:347`, `apps/web/src/components/EconomyAccountPanel.tsx:349`, `apps/web/src/components/EconomyQuestGrid.tsx:96`, `apps/web/src/pages/StorePage.tsx:351`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:303`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:309`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:349`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:340`, `apps/web/src/pages/StorePage.tsx:337`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:345`, `apps/web/src/pages/StorePage.tsx:339`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:345`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:338`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:136`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:137`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:166`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:241`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:242`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:249`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:253`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:217`, `apps/web/src/pages/StorePage.tsx:261`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:286`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:189`
- 수정안:
...
- 사용: `apps/web/src/pages/StorePage.tsx:212`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:398`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:160`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:187`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:196`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:203`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:207`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:211`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:234`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:197`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:271`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:335`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:423`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:424`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:427`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:220`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:222`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:223`
- 수정안:
...
- 사용: `apps/web/src/pages/LobbyPage.tsx:229`
- 수정안:
...
- 사용: `apps/web/src/components/AppSidebar.tsx:29`, `apps/web/src/components/AppSidebar.tsx:40`, `apps/web/src/pages/LobbyPage.tsx:200`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:290`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:484`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:486`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:487`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:510`
- 수정안:
...
- 사용: `apps/web/src/pages/AccountPage.tsx:420`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:408`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:399`
- 수정안:
...
- 사용: `apps/web/src/components/EconomyAccountPanel.tsx:386`
- 수정안:
...
- 현재: DAILY CHECK-IN
- 종류: JSX 본문
- 위치: `apps/web/src/components/AttendanceCheckInModal.tsx:107`
- 수정안:
...
- 현재: Tango 탕고
- 종류: aria-label 속성
- 위치: `apps/web/src/components/BrandMark.tsx:3`
- 수정안:
...
- 현재: TANGO
- 종류: JSX 본문
- 위치: `apps/web/src/components/BrandMark.tsx:11`
- 수정안:
...
- 현재: SELECT COLOR
- 종류: JSX 본문
- 위치: `apps/web/src/components/ColorPicker.tsx:22`
- 수정안:
...
- 현재: TILE LOADOUT
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:159`
- 수정안:
...
- 현재: QUEST & FRAGMENTS
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:270`
- 수정안:
...
- 현재: CHIP LEDGER
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:302`
- 수정안:
...
- 현재: BENEFITS
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:334`
- 수정안:
...
- 현재: COUPON
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:353`
- 수정안:
...
- 현재: COUPON REWARD
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:384`
- 수정안:
...
- 현재: COLOR WARNING
- 종류: JSX 본문
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:421`
- 수정안:
...
- 현재: G
- 종류: JSX 본문
- 위치: `apps/web/src/components/GoogleSignInButton.tsx:136`
- 수정안:
...
- 현재: PATCH NOTES
- 종류: JSX 본문
- 위치: `apps/web/src/components/PatchNotesPanel.tsx:208`
- 수정안:
...
- 현재: MATCH COMPLETE
- 종류: JSX 본문
- 위치: `apps/web/src/components/ResultPanel.tsx:50`
- 수정안:
...
- 현재: PREFERENCES
- 종류: JSX 본문
- 위치: `apps/web/src/components/SettingsPanel.tsx:59`
- 수정안:
...
- 현재: 계정이 삭제되었습니다.
- 종류: setMessage 상태 문구
- 위치: `apps/web/src/pages/AccountPage.tsx:250`
- 수정안:
...
- 현재: 닉네임을 변경했습니다.
- 종류: setMessage 상태 문구
- 위치: `apps/web/src/pages/AccountPage.tsx:265`
- 수정안:
...
- 현재: PLAYER ACCOUNT
- 종류: JSX 본문
- 위치: `apps/web/src/pages/AccountPage.tsx:279`
- 수정안:
...
- 현재: SIGNED IN
- 종류: JSX 본문
- 위치: `apps/web/src/pages/AccountPage.tsx:377`
- 수정안:
...
- 현재: · TURN
- 종류: JSX 본문
- 위치: `apps/web/src/pages/AccountPage.tsx:461`
- 수정안:
...
- 현재: Google
- 종류: JSX 본문
- 위치: `apps/web/src/pages/AccountPage.tsx:516`
- 수정안:
...
- 현재: DELETE ACCOUNT
- 종류: JSX 본문
- 위치: `apps/web/src/pages/AccountPage.tsx:561`
- 수정안:
...
- 현재: AI MATCH
- 종류: JSX 본문
- 위치: `apps/web/src/pages/GamePage.tsx:336`
- 수정안:
...
- 현재: TURN
- 종류: JSX 본문
- 위치: `apps/web/src/pages/GamePage.tsx:337`
- 수정안:
...
- 종류: JSX 본문
- 위치: `apps/web/src/pages/GamePage.tsx:348`
- 수정안:
...
- 종류: JSX 본문
- 위치: `apps/web/src/pages/GamePage.tsx:349`
- 수정안:
...
- 종류: JSX 본문
- 위치: `apps/web/src/pages/GamePage.tsx:409`
- 수정안:
...
- 현재: TANGO
- 종류: JSX 본문
- 위치: `apps/web/src/pages/LobbyPage.tsx:115`
- 수정안:
...
- 현재: PLAY
- 종류: JSX 본문
- 위치: `apps/web/src/pages/LobbyPage.tsx:132`
- 수정안:
...
- 현재: AI
- 종류: JSX 본문
- 위치: `apps/web/src/pages/LobbyPage.tsx:143`
- 수정안:
...
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:652`
- 수정안:
...
- 현재: 🔒 PREMIUM
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:689`
- 수정안:
...
- 현재: ROOM CODE
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:751`
- 수정안:
...
- 현재: TURN
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:812`
- 수정안:
...
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:824`
- 수정안:
...
- 현재: ROOM
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:825`
- 수정안:
...
- 현재: CONFIRM RESIGNATION
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:887`
- 수정안:
...
- 현재: SHARE MATCH
- 종류: JSX 본문
- 위치: `apps/web/src/pages/OnlineRoomPage.tsx:907`
- 수정안:
...
- 현재: TANGO STORE
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:135`
- 수정안:
...
- 현재: WEEKLY SELECTION
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:188`
- 수정안:
...
- 현재: TILE COLLECTION
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:240`
- 수정안:
...
- 현재: PALETTE BOX
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:300`
- 수정안:
...
- 현재: FOUNDER & PREMIUM
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:332`
- 수정안:
...
- 현재: COMING NEXT
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:344`
- 수정안:
...
- 현재: CONFIRM PURCHASE
- 종류: JSX 본문
- 위치: `apps/web/src/pages/StorePage.tsx:383`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:394`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:396`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/components/EconomyAccountPanel.tsx:398`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/components/GameBoard.tsx:88`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/components/GameBoard.tsx:96`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/components/ResultPanel.tsx:74`
- 수정안:
...
- 종류: JSX 동적 문구
- 위치: `apps/web/src/pages/ReplayPage.tsx:194`
- 수정안:
...
- 현재 코드: ``✓ ${t("보유 중")}``
- 종류: JSX 동적 문구
- 위치: `apps/web/src/pages/StorePage.tsx:286`
- 수정안:
