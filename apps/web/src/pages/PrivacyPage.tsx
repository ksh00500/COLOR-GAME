  ...
  return (
    <main className="online-page app-frame">
      ...
      <article className="legal-shell app-content-shell">
        ...
        <section>
          <h2>{t("수집하는 정보")}</h2>
          <p>{t("Tango는 계정 이용 시 이메일, 해시 처리된 비밀번호, 닉네임, 아바타, 레이팅, 전적, 출석 기록, 컬러 칩 잔액과 원장, 보유·장착 스킨, 파편·상자 결과와 쿠폰 수령 기록을 처리합니다. 서비스 운영과 반복 보상 방지를 위해 서명된 익명 게스트 식별자, 접속 경로, 브라우저 정보를 처리할 수 있습니다.")}</p>
        </section>
        <section>
          <h2>{t("이용 목적")}</h2>
